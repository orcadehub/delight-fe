        ...
        <div className="row">
          ...
          <div className="col-md-3 mb-4">
            ...
            <p className="text-light">
              Bring back the timeless flavors of tradition, handcrafted with
              love using authentic methods.
            </p>
          </div>
          ...
          <div className="col-md-3 mb-4">
            ...
            <div className="input-group">
              <input
                type="email"
                className="form-control newsletter-btn"
                placeholder="Enter your email"
              />
              <button className="btn btn-primary sub-btn">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
